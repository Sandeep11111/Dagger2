...
import com.example.sandeepkumarsingh.dagger2.di.DatabaseInfo;
...
public class DbHelper extends SQLiteOpenHelper {
    ...
    protected User getUser(Long userId) throws Resources.NotFoundException, NullPointerException {
        ...
        try {
            ...
            cursor = db.rawQuery(
                    new StringBuilder().append("SELECT * FROM ").append(USER_TABLE_NAME).append(" WHERE ").append(USER_COLUMN_USER_ID).append(" = ? ").toString(),
                    new String[]{userId + ""});
